...
public class NetworkUtils {
	...
	public HttpURLConnection getHttpURLConInstance(String mURL, String type, String contentType, boolean hasToken) throws Exception {
		URL url = new URL(context.getString(R.string.endpoint) + mURL);
		...
		if(hasToken) {
			mHttpPost.setRequestProperty("X-AUTH-TOKEN", appPreferences.getUserToken());
		}
		return mHttpPost;
	}
}
